...
export default function createHTMLPlugin({ useManifest = false, stylePath = 'css/main.css' } = {}) {
    ...
    return {
        ...
        async generateBundle(options, bundle) {
            const templateScr = 'src/template.ejs';
            ...
            const html = ejs.render(template, {
                ...
                useManifest,
                useModules: options.format === 'es' || options.format === 'umd',
                stylePath,
                // fonts: [
